...
build:
	...
	go build -v -o distance_completer.exe ./distance_completer/...
	go build -v -o simple_saver.exe ./simple_saver/...
	go build -v -o server.exe ./server/...
	go build -v -o client.exe ./client/...
	go build -v -o ex4.exe ./ex4/...
	go build -v -o saver_ex3.exe ./saver_ex_3/...
.PHONY: build
